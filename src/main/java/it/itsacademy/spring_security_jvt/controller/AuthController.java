...
public class AuthController {
    ...
    public ResponseEntity<UtenteDTO> signup(@RequestBody SignUpUserDTO signupDto) {
    ...
    public ResponseEntity<Map<String, String>> login(@RequestBody LoginUserDTO loginDto) {
